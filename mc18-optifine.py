...
# Minecraft version
mc_version = "1.18-OptiFine_HD_U_H3"
...
real_command = [
  ...
  '-cp',
  libdir + 'optifine/launchwrapper-of/2.3/launchwrapper-of-2.3.jar:'
  + libdir + 'optifine/OptiFine/1.18_HD_U_H3/OptiFine-1.18_HD_U_H3.jar:'
