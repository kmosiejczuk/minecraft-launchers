...
# Minecraft version
mc_version = "1.13.2-OptiFine_HD_U_G5"
...
real_command = [
  ...
  '-cp',
  lwjgl3_libs
  + libdir + 'optifine/OptiFine/1.13.2_HD_U_G5/OptiFine-1.13.2_HD_U_G5.jar:'
  + libdir + 'optifine/launchwrapper-of/2.2/launchwrapper-of-2.2.jar:'
  + libdir + 'com/mojang/patchy/1.2.3/patchy-1.2.3.jar:'
  ...
  + libdir + 'com/mojang/brigadier/1.0.14/brigadier-1.0.14.jar:'
  + libdir + 'com/mojang/datafixerupper/1.0.19/datafixerupper-1.0.19.jar:'
  ...
  + libdir + 'com/mojang/realms/1.13.9/realms-1.13.9.jar:'
